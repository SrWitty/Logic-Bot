    ...
    async execute (interaction) {
        ...
        switch (sub) {
            ...
            const rule = await guild.autoModerationRules.create({
                name: `Block profinity, sexual content, and slurs by Elementor Bot`,
                creatorId: '1049707375952679032',
                enabled: true,
                eventType: 1,
                triggerType: 4,
                triggerMetadata: 
                ...
                actions: [
                    {
                        ...
                        metadata: {
                            ...
                            durationSeconds: 10,
                            customMessage: 'This message was prevented by Elementor Bot'
                        }
                    }
                ]
            }).catch(async err => {
            ...
            const rule2 = await guild.autoModerationRules.create({
                name: `Prevent the word ${word} by Elementor Bot`,
                creatorId: '1049707375952679032',
                enabled: true,
                eventType: 1,
                triggerType: 1,
            ...
            const rule3 = await guild.autoModerationRules.create({
                name: `Prevent Spam Messages by Elementor Bot`,
                creatorId: '1049707375952679032',
                enabled: true,
                eventType: 1,
                triggerType: 5,
